         ...
         <br>
                    ...
                    <style>
                        table,tr,th,td{
                          ...
                          <h2 style="  color:#BB1ED5 ; text-align: center; font-size: 25px; font-weight: bolder; margin-left:50px; "> View Status and Send Key!</h2>
                          <br>
                          <table style=" margin-left: 300px; margin-bottom: 100px;">
                      
                            <tr>
                            <th style=" background-color:#EB6102;">ID</th>
                            <th style=" background-color: #EB6102;">Owner name</th>
                            <th style=" background-color:#EB6102;">File Name</th>
                            <th style=" background-color:#EB6102;">User ID</th>
                            <th style=" background-color:#EB6102;">User Name</th>
                             <th style=" background-color:#EB6102;">Email</th>
                            <th style=" background-color:#EB6102;">Status</th>
                            <th style=" background-color:#EB6102;">Send Key</th>
