  ...
  <section >
         ...
         <br>
                    ...
                    background-color: #EB6102;
                         ...
                         <h2 style="  color:#BB1ED5 ; text-align: center; font-size: 25px; font-weight: bolder; margin-left:-50px; ">View Re-Encryption File Request!!</h2>
                          <br>
                        <br>
                        <br>
                         
                    <table style=" margin-left: 450px; margin-bottom: 100px;">
                              <tr>
                            <th>ID</th>
                            <th>Username</th>
                            <th>Email</th>
