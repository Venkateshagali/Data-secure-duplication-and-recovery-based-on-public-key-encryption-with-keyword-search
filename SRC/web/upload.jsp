...
for (long i=code;i!=0;i/=100)
    ...
    System.out.println("unique password ="+unique_password);
                  ...
                  %>
                  <h2 style="  color:#BB1ED5 ; text-align: center; font-size: 25px; margin-bottom:10px;  font-weight: bolder; margin-left:-50px; "> Upload File!!</h2>
                          <br>
                        <br>
                        <br>
                      <form action='Upload1' method="post" enctype="multipart/form-data">       
                          
                             <table style=" font-size:20px;margin-top:-200px;" align="center">
                            ...
                            <tr><td align='center' colspan="2"><input type="submit" Value='Upload' style="border-radius: 2px; width: 100px; height: 30px;padding: 5px; text-align: center;font-size:15px;background-color:  #EB6102; color: #000;"</td></tr>
                             </table>
                        </form>   
