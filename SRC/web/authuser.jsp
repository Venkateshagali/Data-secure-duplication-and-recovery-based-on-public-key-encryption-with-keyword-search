         ...
         <br>
                    ...
                    <style>
                        table,tr,th,td{
                          ...
                          <h2 style="  color:#BB1ED5 ; text-align: center; font-size: 25px; font-weight: bolder; margin-left:-180px; "> Authorize Users!!</h2>
                          <br>
                          <table style=" margin-left: 400px; margin-bottom: 100px;">
                              <tr>
                            <th  style=" background-color: #EB6102;">ID</th>
                            <th  style=" background-color: #EB6102;">Username</th>
