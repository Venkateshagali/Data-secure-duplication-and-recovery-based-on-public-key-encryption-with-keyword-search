         ...
         <br>
                    ...
                    <style>
                     ...
                     margin-left:350px;
                         ...
                         <h2 style="  color:#BB1ED5 ; text-align: center; font-size: 25px; font-weight: bolder; margin-left:-50px; ">View Cloud Status and Upload !!</h2>
                          <br>
                        <br>
                        <br>
                    ...
                    <table>
       <tr>
           <td style=" font-weight: bold; background-color:  #EB6102;">ID</td>
           <td style=" font-weight: bold; background-color:  #EB6102;">Owner name</td>
           <td style=" font-weight: bold; background-color:  #EB6102;">File</td>
           <td style=" font-weight: bold; background-color:  #EB6102;">Keyword</td>
      
           <td style=" font-weight: bold; background-color:  #EB6102;">Re-encryption Status</td>
           <td style=" font-weight: bold; background-color:  #EB6102;">Upload file</td>
            </tr>
