  ...
  <section >
         ...
         <br>
                    ...
                    <style>
                        ...
                        td{
                          ...
                          <h2 style="  color:#BB1ED5 ; text-align: center; font-size: 30px; font-weight: bolder; margin-left:-0px; ">  User Profile!!</h2>
                          <br>
                         <%                    
      ...
      Class.forName("com.mysql.jdbc.Driver");
                        ...
                        while(rs.next()){
                         ...
                         <table>
                            <tr>
                            <tr align="center"><td colspan="2" style="  background-color:#0dcaf0;"><img src="profile/<%=rs.getString("profile")%>" alt="image" style="width:400px; height: 180px;"></td></tr>
